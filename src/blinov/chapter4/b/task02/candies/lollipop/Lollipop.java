package blinov.chapter4.b.task02.candies.lollipop;
...
public class Lollipop extends Candy {
	...
	public Lollipop(String name, int weight, int percentageOfSugar) {
	...
	public String toString() {
		return "Lollipop [name=" + name + ", weight=" + weight + ", percentageOfSugar=" + percentageOfSugar + "]";
	}
