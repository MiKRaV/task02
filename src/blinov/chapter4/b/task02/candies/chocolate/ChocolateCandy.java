package blinov.chapter4.b.task02.candies.chocolate;
...
public class ChocolateCandy extends Candy{
	...
	public ChocolateCandy(String name, int weight, int percentageOfSugar) {
	...
	public String toString() {
		return "ChocolateCandy [weight=" + weight + ", percentageOfSugar=" + percentageOfSugar + "]";
	}
