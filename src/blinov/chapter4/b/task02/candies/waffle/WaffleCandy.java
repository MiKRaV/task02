package blinov.chapter4.b.task02.candies.waffle;
...
public class WaffleCandy extends Candy{
	...
	public WaffleCandy(String name, int weight, int percentageOfSugar) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		WaffleCandy other = (WaffleCandy) obj;
		if (name == null) {
			if (other.name != null)
				return false;
	...
	public String toString() {
		return "WaffleCandy [name=" + name + ", weight=" + weight + ", percentageOfSugar=" + percentageOfSugar + "]";
	}
